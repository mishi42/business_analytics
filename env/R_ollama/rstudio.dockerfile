...
RUN install2.r --error --skipmissing --skipinstalled \
    ...
    proxy FinCal Benchmarking inventorize planr roptim DEoptim ompr.roi ROI.plugin.glpk nloptr simmer queueing \
    ...
    tidytext \
    tm stm stringr stringi topicmodels lda LDAvis textmineR gutenbergr methods spacyr text GermaParl transport gsaot T4transport approxOT CytOpT r5r \
