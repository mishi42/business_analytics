...
RUN install2.r --error --skipmissing --skipinstalled \
    ...
    clickstream \
    seqHMM superheat depmixS4 edeaR stagedtrees markovchain dtw ChannelAttribution completejourney HMM HiddenMarkov dtwclust TSclust　funtimes pdc latrend tsfeatures otsfeatures \
